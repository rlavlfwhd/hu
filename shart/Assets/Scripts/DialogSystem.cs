...
public class DialogSystem : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (dialogsDB)
        {
            ...
            foreach (Entity_SelectData.Param param in entity_SelectData.sheets[0].list)
            {
                ...
                selectData[ArrayCursor].select_04 = param.select_04;
    ...
    private void SetNextSelect(int currentIndex)
    {
        ...
        else if (selectData[currentIndex].selectAmount == 4)
        {
            select_003.SetActive(true);
            selectTextMain_02.text = selectData[currentIndex].selectMain;
            select_003_Button_01_Text.text = selectData[currentIndex].select_01;
            select_003_Button_02_Text.text = selectData[currentIndex].select_02;
            select_003_Button_03_Text.text = selectData[currentIndex].select_03;
            select_003_Button_04_Text.text = selectData[currentIndex].select_04;
        }
    }
